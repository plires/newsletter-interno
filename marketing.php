...
<head>
  ...
  <title>Vistage - Newsletter, Marketing</title>
      ...
      <section class="content">
        ...
        <div class="container">
                ...
                <div class="card-body">
                  <ul v-if="newslettersCurrentYear" class="pagination pagination-month justify-content-center">
                    ...
                    <li v-for="newsletter in newslettersCurrentYear" :key="newsletter.id" :class="['page-item', newsletterActive(newsletter.month)]">
                      <button class="page-link" @click="setCurrentNewsletter(newsletter.id, 'marketing', 'preview_marketing')">
          ...
          <section v-if="currentNewsletter.execute == 0" class="row">
            <div id="preview_marketing" class="col-md-12">
              <div class="card card-primary">
                ...
                <div v-html="currentNewsletter.marketing" class="card-body">
                </div>

                <div class="card-footer">
                  <button id="btnEditar" type="button" @click="initSummerNote('comment_marketing', 'marketing', 'preview_marketing')" class="btn btn-primary float-right">Editar</button>
                </div>
                
              </div>
            </div>

            <div id="marketing" class="col-md-12">
              ...
              <div class="card card-warning">
                ...
                <!-- form start -->
                <form method="post" @submit.prevent="submitForm(currentNewsletter, 'comment_marketing', 'marketing', 'preview_marketing')">

                  <div class="card-body">
                    <div class="form-group">
                      <textarea id="comment_marketing" name="comment_marketing" class="form-control summernote" rows="3"></textarea>
                    </div>
                  </div>

                  <div class="card-footer">
                    <button id="btnGuardar" type="submit" class="btn btn-warning float-right ml-3">Guardar</button>
                    <button id="btnCancelar" type="button" @click="cancelEditNewsletter('marketing', 'preview_marketing')" class="btn btn-default float-right">Cancelar</button>
                  </div>
